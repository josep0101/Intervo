...
router.post("/make-call", async (req, res) => {
  try {
    ...
    const workflowConfig = {
      url: "https://development-api.voxa.ai/workflow/be17a9ba-7402-4f96-9bbe-0be5bd238c6e",
...
router.get("/config", (req, res) => {
  res.json({
    workflowEndpoint: "https://development-api.voxa.ai/workflow/be17a9ba-7402-4f96-9bbe-0be5bd238c6e",
