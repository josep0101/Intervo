...
// To be removed: Fetch available Voxa numbers from the pool? (not used in the UI)
router.get("/voxa", async (req, res) => {
  try {
...
// Happens when the user makes a purchase. To be completed Request a temporary number from the Voxa pool
...
// Release the user's temporary number back to the Voxa pool
