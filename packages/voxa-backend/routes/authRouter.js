...
router.post('/logout', async (req, res) => {
  ...
  // Options for clearing cookies set for voxa.ai domain
  const voxaCookieClearOptions = {
  ...
  res.clearCookie('authToken', voxaCookieClearOptions);
  res.clearCookie('refreshToken', voxaCookieClearOptions);
...
router.get('/verification-stats', async (req, res) => {
  try {
    ...
    if (!user || !user.email.endsWith('@voxa.ai')) {
